...
representatives of projects taking part in \textbf{Reproducible Builds} effort
...
A number of tools was designed by \textbf{Reproducible Builds} community to help open-source 
...
\textbf{Reproducible Builds} project members have also come up with a 
