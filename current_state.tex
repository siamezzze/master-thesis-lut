\chapter{Current state of the Reproducible Builds project}

\section[Debian]{Debian}
\nopagebreak[4]{
...
\end{itemize}
\subsection[Continuous testing of Debian packages]{Continuous testing of Debian packages} 
...
\end{figure}
\subsection[Categorizing the issues]{Categorizing the issues} 
...
\section[Other projects]{Other projects}
\nopagebreak[4]{
