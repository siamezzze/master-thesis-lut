...
features are added to diffoscope, making it more useful for
reproducibility testing.
}

\subsection[Objectives and delimitations]{Objections and delimitations}
\nopagebreak[4]{
Main goal of this work is improvement of the diffoscope tool, making
...
\begin{itemize}
    ...
    \item Improving overall usability of diffoscope.\\
    ...
    \item Improving run speed of diffoscope.\\
    In real applications, diffoscope is often run on big files
    ...
    It is important to make diffoscope as time-efficient as possible
...
making diffoscope run in parallel. The difficulty of this task renders it
