...
Section 4 focuses on specific problems this work is aiming to solve, outlining some of the ways in which diffoscope could be improved.
Section 5 describes the implementation of new features added to diffoscope.
Section 6 gives the overview of the current state of the project with focus on how the described tools are used in various situations.
Section 7 contains the conclusions of the work.
